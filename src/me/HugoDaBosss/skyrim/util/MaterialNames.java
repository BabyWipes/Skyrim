...
public enum MaterialNames {
    ...
    private MaterialNames(final String name){
        this.name = name;
    }
    ...
    public static String correctName(String a)
    {
    	String result = "";
    ...
    public static String itemName(Material type){
    	return correctName(MaterialNames.valueOf(type.toString()).toString());
    }
}
