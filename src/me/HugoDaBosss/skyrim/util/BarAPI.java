...
public class BarAPI {
  public static final int ENTITY_ID = 1234;
	...
	public static void displayTextBar(String text, final Player player){
		...
		/*l.setZ(l.getZ() + 20);
		PacketPlayOutSpawnEntityLiving mobPacket2 = getMobPacket(text, l);
		sendPacket(player, mobPacket2);
		l.setZ(l.getZ() - 10);
		l.setX(l.getX() - 10);
		PacketPlayOutSpawnEntityLiving mobPacket3 = getMobPacket(text, l);
		sendPacket(player, mobPacket3);
		l.setX(l.getX() + 20);
		PacketPlayOutSpawnEntityLiving mobPacket4 = getMobPacket(text, l);
		sendPacket(player, mobPacket4);*/
	...
	public static void displayLoadingBar(final String text, final String completeText, final Player player, final int healthAdd, final long delay, final boolean loadUp){
		...
		}.runTaskTimer(Skyrim.getPlugin(), delay, delay);
	}
