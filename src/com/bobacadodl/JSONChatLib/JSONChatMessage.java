...
public class JSONChatMessage {
    ...
    public void sendToPlayer(Player player) {
        ...
        ((org.bukkit.craftbukkit.v1_7_R3.entity.CraftPlayer) player).getHandle().playerConnection.sendPacket(new PacketPlayOutChat(ChatSerializer.a(chatObject.toJSONString()), true));
